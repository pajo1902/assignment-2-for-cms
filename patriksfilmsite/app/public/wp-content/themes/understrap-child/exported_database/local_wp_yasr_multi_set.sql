...
DROP TABLE IF EXISTS `wp_yasr_multi_set`;
...
--
-- Dumping data for table `wp_yasr_multi_set`
--

LOCK TABLES `wp_yasr_multi_set` WRITE;
/*!40000 ALTER TABLE `wp_yasr_multi_set` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_yasr_multi_set` ENABLE KEYS */;
UNLOCK TABLES;
